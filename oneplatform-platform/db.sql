...
('1005','人事管理服务', 'organisation-service', 'organisation', '0', '1','/api/organisation/swagger-ui.html','service'),
...
(1000,'0', NULL, '系统管理', 'menu', NULL, NULL, 'admin'),
...
(2000,'0', NULL, '权限管理', 'menu', NULL, NULL, 'admin'),
...
(3000,'0', NULL, '用户管理', 'menu', NULL, NULL, 'admin'),
(3001,'3000', '1002', '用户列表', 'menu', '/modules/user/list.html', 'GET', 'admin'),
(4000,'0', NULL, '人事管理', 'menu', NULL, NULL, 'admin'),
...
(5000,'0', NULL, '智能API', 'menu', NULL, NULL, 'admin'),
...
(6000,'0', NULL, '系统监控', 'menu', NULL, NULL, 'admin'),
...
(7000,'0', NULL, 'CMS内容管理', 'menu', NULL, NULL, 'admin'),
(7001,'7000', '1004', '分类管理', 'menu', '/modules/cms/categorys.html', 'GET', 'admin'),
(7002,'7000', '1004', '文章管理', 'menu', '/modules/cms/articles.html', 'GET', 'admin');
