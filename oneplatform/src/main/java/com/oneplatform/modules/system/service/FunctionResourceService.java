...
import com.oneplatform.modules.system.dto.MenuItem;
import com.oneplatform.modules.system.dto.ResourceItem;
import com.oneplatform.modules.system.dto.param.FunctionResourceParam;
...
public class FunctionResourceService {
    ...
    public IdParam<Integer> addFunctionResource(FunctionResourceParam param){
    	...
    	if(functionResourceMapper.findByUri(param.getUri()) != null){
    		throw new JeesuiteBaseException("菜单已经存在["+param.getUri()+"]");
    	}
    ...
    public void updateFunctionResource(FunctionResourceParam param){
        ...
        FunctionResourceEntity sameUriEntity = functionResourceMapper.findByUri(param.getUri());
